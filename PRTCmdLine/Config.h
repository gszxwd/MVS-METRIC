...
struct SIMULATOR_OPTIONS
{
    ...
    DWORD dwNumRays;
    DWORD dwNumBounces;
	//Scale of the 3D scene relative to a 1-mm cube. 
	//Used for subsurface scattering computations.
    float fLengthScale;
	//Number of color channels to set in the mesh. 
	//Set to 1 to specify gray materials (R = G = B), 
	//or 3 to enable color bleeding effects.
    DWORD dwNumChannels;
